---
layout: page
title: Great Downtown Boise Happy Hour
description: >-
  A researched guide to downtown Boise happy hours — real days, hours, and
  drink/food specials, plus which of our personal favorites has the best
  deals, so you're not guessing when you show up.
permalink: /downtown-happy-hour/
comments: true
...
**Mai Tai** doesn't currently have a dine-in happy hour — the Union Block building it operated out of was condemned for structural issues, and as of this writing it's cloud-kitchen delivery and limited patio pickup only. We're hoping this changes; see the [eateries list]({{ site.baseurl }}/boise-eateries/) for more.
